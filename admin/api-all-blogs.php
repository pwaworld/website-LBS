...
$query = "SELECT id, title, subtitle, authorname, thumnail_img, post_img ,video_link, m_description1, m_description2, m_description3, m_description4, m_description5, metatags, created_at FROM blog_submissions";
